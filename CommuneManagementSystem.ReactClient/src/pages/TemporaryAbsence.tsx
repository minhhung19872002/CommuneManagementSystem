      ...
      <div className="civic-page-hero">
        <div className="civic-page-hero__inner">
          <div className="civic-page-hero__left">
            <div className="civic-page-hero__eyebrow">Quản lý / Tạm vắng</div>
            <h1 className="civic-page-hero__title">Quản lý Tạm vắng</h1>
            <p className="civic-page-hero__subtitle">
              Đăng ký, gia hạn và theo dõi công dân tạm vắng khỏi địa phương.
            </p>
          </div>
